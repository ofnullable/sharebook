...
export default (state = initial, action) => {
  return produce(state, draft => {
    switch (action.type) {
      ...
      case BOOK.LOAD_MY_BOOK_LIST_BY_LENDING_STATUS_REQUEST:
      ...
      case BOOK.LOAD_MY_BOOK_LIST_BY_LENDING_STATUS_SUCCESS:
      ...
      case BOOK.LOAD_MY_BOOK_LIST_BY_LENDING_STATUS_FAILURE:
