...
VALUES
       ("이것이 우분투 리눅스다", "우재남", "한빛미디어", 1,"description for test book1", 1, "https://placeimg.com/200/300/animals", 2, 3, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("리눅스 시스템 원리와 실제", "창병모", "생능출판사", 1,"description for test book2", 1, "https://placeimg.com/200/300/animals", 2, 2, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("컴퓨터 네트워킹 : 하향식 접근(7판)", "James F. Kurose", "퍼스트북", 2,"description for test book3", 1, "https://placeimg.com/200/300/animals", 2, 2, now(), "test2@asd.com", now(), "test2@asd.com"),
