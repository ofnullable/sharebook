...
VALUES
       ("이것이 우분투 리눅스다", "우재남", "한빛미디어", 1,"description for test book1", 2, "https://placeimg.com/200/300/animals", 2, 3, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("리눅스 시스템 원리와 실제", "창병모", "생능출판사", 1,"description for test book2", 2, "https://placeimg.com/200/300/animals", 2, 2, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("컴퓨터 네트워킹 : 하향식 접근(7판)", "James F. Kurose", "퍼스트북", 2,"description for test book3", 2, "https://placeimg.com/200/300/animals", 2, 2, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("두근두근 파이썬", "천인국", "생능출판사", 3,"description for test book4", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("명품 C++ Programming", "황기태", "생능출판사 ", 3,"description for test book5", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),

       ("이것이 우분투 리눅스다", "우재남", "한빛미디어", 1,"description for test book1", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("리눅스 시스템 원리와 실제", "창병모", "생능출판사", 1,"description for test book2", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("컴퓨터 네트워킹 : 하향식 접근(7판)", "James F. Kurose", "퍼스트북", 2,"description for test book3", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("두근두근 파이썬", "천인국", "생능출판사", 3,"description for test book4", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),
       ("명품 C++ Programming", "황기태", "생능출판사 ", 3,"description for test book5", 1, "https://placeimg.com/200/300/animals", 2, null, now(), "test2@asd.com", now(), "test2@asd.com"),
       ...
       ("이것이 우분투 리눅스다", "우재남", "한빛미디어", 1,"description for test book1", 2, "https://placeimg.com/200/300/animals", 1, null, now(), "test1@asd.com", now(), "test1@asd.com"),
       ("리눅스 시스템 원리와 실제", "창병모", "생능출판사", 1,"description for test book2", 2, "https://placeimg.com/200/300/animals", 1, null, now(), "test1@asd.com", now(), "test1@asd.com"),
       ("컴퓨터 네트워킹 : 하향식 접근(7판)", "James F. Kurose", "퍼스트북", 2,"description for test book3", 1, "https://placeimg.com/200/300/animals", 1, null, now(), "test1@asd.com", now(), "test1@asd.com"),
       ("두근두근 파이썬", "천인국", "생능출판사", 3,"description for test book4", 2, "https://placeimg.com/200/300/animals", 1, null, now(), "test1@asd.com", now(), "test1@asd.com"),
       ("명품 C++ Programming", "황기태", "생능출판사 ", 3,"description for test book5", 2, "https://placeimg.com/200/300/animals", 1, null, now(), "test1@asd.com", now(), "test1@asd.com");
...
VALUES
       (65, 2, "나는 휴머니즘. 평등주의자라고 강력하게 생각하고 있었는데 이 책을 읽으며 내가 얼마나 편협한 생각을 하고 있었는지 다시 한번 생각하게 되네요. 쉽지 않은 내용인데 쉽게 잘 풀어주셔서 술술 읽으며 많은 밑줄을 긋고 책갈피를 하며 봤습니다", 5, "test2@asd.com", now(), "test2@asd.com", now()),
       (65, 3, "권력과 차별을 이토록 섬세하게 풀어내주시다니요~ 개인적으로 역대 밑줄 친 부분이 가장 많은 책입니다", 3, "test3@asd.com", now(), "test3@asd.com", now());
