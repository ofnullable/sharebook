...
INSERT INTO share_jpa.book_category(name, display, created_at, created_by, modified_at, modified_by)
...
VALUES ("이것이 우분투 리눅스다", "우재남", "한빛미디어", 1,"description for test book1", "https://placeimg.com/200/300/animals", "test1@asd.com", now(), "test1@asd.com", now(), "test1@asd.com");
INSERT INTO share_jpa.book(title, author, publisher, category_id, description, image_url, owner, created_at, created_by, modified_at, modified_by)
...
VALUES ("두근두근 파이썬", "천인국", "생능출판사", 3,"description ", "https://placeimg.com/200/300/animals", "test1@asd.com", now(), "test1@asd.com", now(), "test1@asd.com");
INSERT INTO share_jpa.book(title, author, publisher, category_id, description, image_url, owner, created_at, created_by, modified_at, modified_by)
VALUES ("명품 C++ Programming", "황기태", "생능출판사 ", 3,"description for test book5", "https://placeimg.com/200/300/animals", "test1@asd.com", now(), "test1@asd.com", now(), "test1@asd.com");INSERT INTO share_jpa.book(title, author, publisher, category_id, description, image_url, owner, created_at, created_by, modified_at, modified_by)
                                                                                                                                                                                        VALUES ("이것이 우분투 리눅스다", "우재남", "한빛미디어", 1,"description for test book1", "https://placeimg.com/200/300/animals", "test1@asd.com", now(), "test1@asd.com", now(), "test1@asd.com");
INSERT INTO share_jpa.book(title, author, publisher, category_id, description, image_url, owner, created_at, created_by, modified_at, modified_by)
VALUES ("리눅스 시스템 원리와 실제", "창병모", "생능출판사", 1,"description ", "https://placeimg.com/200/300/animals", "test1@asd.com", now(), "test1@asd.com", now(), "test1@asd.com");
INSERT INTO share_jpa.book(title, author, publisher, category_id, description, image_url, owner, created_at, created_by, modified_at, modified_by)
